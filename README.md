...
Thirty primitives make up the vocabulary the choreographer may call, drawing on
fifty-seven effect sprites — every one generated by this repo:
...
whole choreography is capped at eleven, with overruns time-scaled to fit rather
than truncated — and short ones stretched toward seven and a half, because
models reliably write four-second moves and four seconds is over before a room
has looked up. Anything unusable — a refused request, malformed JSON, an
